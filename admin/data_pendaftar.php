                            ...
                            <?php
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="data_pendaftar_view.php?id_pendaftar=<?= $row['id_pendaftar']; ?>" class="waves-effect waves-light btn blue"><i class="material-icons center">visibility</i></a>
                                            <a href="data_pendaftar_delete.php?id_pendaftar=<?= $row['id_pendaftar']; ?>" class="waves-effect waves-light btn black"><i class="material-icons center">delete</i></a>
                                        </td>
                                    </tr>
                                <?php
                                    }
